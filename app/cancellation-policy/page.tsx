...
export default function Page() {
  return (
    <LegalPage title="Cancellation Policy">
      ...
      <LegalSection title="How to Request Cancellation"><p>Cancellation requests must be sent in writing to hello@asmanai.com and should include the project name, invoice reference, and reason for cancellation.</p></LegalSection>
    </LegalPage>
  );
}
