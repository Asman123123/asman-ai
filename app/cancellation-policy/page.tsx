...
export const metadata: Metadata = { title: "Cancellation Policy", description: "Cancellation policy for ASMAN TECH projects." };

export default function Page() {
  return (
    <LegalPage title="Cancellation Policy">
      <p>Because ASMAN TECH provides custom digital services, cancellation requests are reviewed based on project status, work completed, resources allocated, and written agreements.</p>
      <LegalSection title="Before Work Begins"><p>If a cancellation request is received before work begins, ASMAN TECH may review whether any refundable amount is available after payment processing fees, administrative costs, scheduled resource allocation, and onboarding preparation.</p></LegalSection>
