...
export const metadata: Metadata = { title: "Privacy Policy", description: "Privacy policy for ASMAN TECH." };

export default function Page() {
  return (
    <LegalPage title="Privacy Policy">
      <p>ASMAN TECH collects business contact information submitted through forms, emails, booking links, or project communication channels to respond to inquiries, prepare proposals, deliver services, and maintain business records.</p>
