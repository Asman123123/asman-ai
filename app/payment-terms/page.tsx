...
export const metadata: Metadata = { title: "Payment Terms", description: "Payment terms for ASMAN TECH services." };
...
export default function Page() {
  return (
    <LegalPage title="Payment Terms">
      ...
      <LegalSection title="Payment Disputes"><p>Clients should contact ASMAN TECH directly about payment questions or disputes before initiating any payment reversal or chargeback.</p></LegalSection>
    </LegalPage>
  );
}
