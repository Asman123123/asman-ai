...
export const metadata: Metadata = { title: "Cookie Policy", description: "Cookie policy for Asman AI." };

export default function Page() {
  return (
    <LegalPage title="Cookie Policy">
      <p>Asman AI may use cookies and similar technologies to operate the website, understand performance, improve user experience, and measure marketing effectiveness.</p>
