...
export const metadata: Metadata = { title: "Project Delivery Policy", description: "Project delivery policy for Asman AI projects." };

export default function Page() {
  return (
    <LegalPage title="Project Delivery Policy">
      <p>This Project Delivery Policy explains how Asman AI manages scope, timelines, client responsibilities, delivery, revisions, and project delays.</p>
      ...
      <LegalSection title="Project Suspension"><p>Asman AI may pause or reschedule work if required information is missing, approvals are delayed, payment issues arise, or scope changes materially affect delivery.</p></LegalSection>
