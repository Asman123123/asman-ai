...
export const metadata: Metadata = { title: "Refund Policy", description: "Refund policy for ASMAN TECH custom services." };
...
export default function Page() {
  return (
    <LegalPage title="Refund Policy">
      ...
      <LegalSection title="Chargeback Protection"><p>Clients agree not to initiate chargebacks for approved services that have been purchased, started, partially delivered, delivered, or made available. Any payment dispute should first be addressed directly with ASMAN TECH at asman.usa88@gmail.com.</p></LegalSection>
    </LegalPage>
  );
}
