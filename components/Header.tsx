  ...
  return (
    <header className={cn(
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8">
        <Link href="/" className="relative block h-10 w-[168px] shrink-0 overflow-hidden md:w-[190px]" aria-label="Asman AI home">
          <Image src="/brand/asman-ai-white.png" alt="Asman AI" fill sizes="190px" priority className="object-contain object-left" />
        </Link>
